...
L.druidBar = 'Показывать пользовательские полосы маны для друидов'
...
L.pointDefault = 'Восстановить точку по умолчанию'
L.pointTargetLeftTop = 'Позиция вверху слева'
L.pointTargetCenter = 'По центру по горизонтали'
L.pointPlayerAlignment = 'Горизонтальное выравнивание'
L.pointPlayerCenter = 'По центру по горизонтали'
