...
L.focus = 'Рамка фокуса'
L.focustarget = 'Рамка цели фокуса'
...
L.dalaran = 'Даларан'
L.autoDalaran = 'Автоматически скрывать индикаторы здоровья в Даларане'
...
L.threatLeft = 'Показывать значение угрозы слева'
...
L.fiveSecondRule = 'Правило пяти секунд для полосы маны'
L.border = 'Граница'
L.borderList = {
	[1] = 'Обычная',
	[2] = 'Редкая',
...
L.debuffCooldown = 'Показывать только КД дебаффов, которые можно рассеять'
...
L.talentIcon = 'Показывать мини-значок (нажмите для смены талантов)'
L.autoTalentEquip = 'Автоматический набор экипировки по названию талантов'
